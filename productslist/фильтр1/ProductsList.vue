      ...
      <div class="content__catalog">
        <aside class="filter">
          <form class="filter__form form" action="#" method="get">
            ...
            <button class="filter__submit button button--primery" type="button" @click="filter()">
              Применить
            </button>
        ...
        <section class="catalog">
         <ul class="catalog__list">
            ...
            >
              ...
              <span class="catalog__price"> {{ item.item.price }} ₽ </span>
          ...
          <ul class="catalog__pagination pagination">
            ...
            <li class="pagination__item">
              <a
                @click="paginationNext" class="pagination__link pagination__link--arrow"
                href="#"
...
const BASEURL = "https://vue-moire.skillbox.cc/api/";
export default {
  name: "ProductsList",
  data() {
    return {
  ...
  methods: {
    ...
    currentFilterProducts() {
      ...
      this.productsCurrent=this.filterProductsAll.slice(offset,offset+this.perpage)
    ...
    calculateNumber(num) {
      ...
      this.countPagination = Math.ceil(
         num / this.perpage)
  ...
  filteredFrom(){
    return this.productsCurrent = this.products.filter(this.filterPriceFrom);
  }
