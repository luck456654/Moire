        ...
        <aside class="filter">
          <form class="filter__form form" action="#" method="get">
            ...
            <ul class="form__colors">
              <li v-for="item in arrColors"
              :key="item.id">
              <div class="form__color-item" :style="{ backgroundColor: item }"></div>
              </li>  
            </ul>    
  ...
  methods: {
    ...
    collectionCollor() {
      for (let i = 0; i < this.products.length; i++) {
        this.arrColors.push(this.products[i].color);
      }
      this.arrColors = Array.from(new Set(this.arrColors));
